...
class SIRModel:
    @staticmethod
    def run_sir_simulation(N, I0, R0, beta, gamma, delta, days):
        """Run SIR/SIRD model simulation"""
        S = N - I0 - R0
        I = I0
        R = R0
        D = 0
        
        S_data, I_data, R_data, D_data = [S], [I], [R], [D]
        
        for day in range(days):
            # Calculate derivatives
            dS = -beta * S * I / N if N > 0 else 0
            dI = beta * S * I / N - gamma * I - delta * I if N > 0 else 0
            dR = gamma * I
            dD = delta * I
        ...
        return S_data, I_data, R_data, D_data
